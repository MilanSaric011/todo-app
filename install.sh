...
echo -e "${OPENCODELIGHT}║${NC}     ${BOLD}TaskMaster - Professional TUI Task Manager${NC}     ${OPENCODELIGHT}║${NC}"
echo -e "${OPENCODELIGHT}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
# ═══════════════════════════════════════════════════════════════
echo ""
echo -e "${YELLOW}▸ Installing TaskMaster...${NC}"
...
cat > "$LAUNCHER" << 'EOF'
#!/bin/bash
# TaskMaster - Launcher Script
# Generated by installer

INSTALL_DIR="$HOME/.local/share/taskmaster"

if [ ! -f "$INSTALL_DIR/taskmaster.py" ]; then
    echo "Error: TaskMaster not found at $INSTALL_DIR"
